...
$db['default'] = array_merge([
    ...
    'failover' => [],
    'save_queries' => true,
    'strict_on' => false, // Ensure this is correct
], defined('APP_DB_STRICTON') && APP_DB_STRICTON || !defined('APP_DB_STRICTON') ? ['stricton' => false] : []);

/*
$db['default'] = array_merge([
    'dsn'          => '', // Not Supported
    'hostname'     => "dbaas-db-6544966-do-user-13752361-0.c.db.ondigitalocean.com",
    'port'         => "25060",
    'username'     => "crmuser",
...
// echo  defined('APP_DB_DRIVER') ? APP_DB_DRIVER : 'mysqli';
// print_r($db['default']);
/* * APP_DB_STRICTON * @see https://stackoverflow.com/questions/54235523/unknown-column-strict-all-tables-setting-up-codeigniter-db-connection */
