...
class Staff_model extends App_Model
{
    ...
    public function add($data)
    {
        ...
        $data['dialer_phone'] = $data['dialer_phone'] ?? '';
        $data['dialer_agent_id'] = $data['dialer_agent_id'] ?? '';
        $data['dialer_login_username'] = $data['dialer_login_username'] ?? '';
        $data['dialer_login_password'] = $data['dialer_login_password'] ?? '';
