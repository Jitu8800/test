...
class UserReport extends AdminController
{
    ...
    public function index($id = '')
    {
        ...
        $this->load->view('admin/userreports/manage_leads', $data);
    }
    ...
    public function table()
    {
        ...
        $this->app->get_table_data_user('userleads');
    }
    ...
    public function kanban()
    {
        ...
        echo $this->load->view('admin/userreports/kan-ban', $data, true);
    }
    ...
    public function lead($id = '')
{
    ...
    private function _get_lead_data($id = '')
    {
        ...
        return [
            'data'          => $this->load->view('admin/userreports/lead', $data, true),
    ...
    public function leads_kanban_load_more()
    {
        ...
        foreach ($leads as $lead) {
            $this->load->view('admin/userreports/_kan_ban_card', [
                'lead'   => $lead,
                'status' => $status,
            ]);
        }
    ...
    public function get_convert_data($id)
    {
        ...
        $this->load->view('admin/userreports/convert_to_customer', $data);
    }
    ...
    public function form($id = '')
    {
        ...
        $this->load->view('admin/userreports/formbuilder', $data);
    }
    ...
    public function forms($id = '')
    {
        ...
        $data['title'] = _l('web_to_lead');
        $this->load->view('admin/userreports/forms', $data);
    }
    ...
    public function sources()
    {
        ...
        $this->load->view('admin/userreports/manage_sources', $data);
    }
    ...
    public function statuses()
    {
        ...
        $this->load->view('admin/userreports/manage_statuses', $data);
    }
    ...
    public function email_integration()
    {
        ...
        $this->load->view('admin/userreports/email_integration', $data);
    }
    ...
    public function import()
    {
        ...
        $this->load->view('admin/userreports/import', $data);
    }
