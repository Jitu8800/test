...
class Customers extends AdminController
{
    ...
    {
        parent::__construct();
        $this->load->model('customer_model','leads_model');
    }
    ...
    public function index($id = '')
    {
        ...
        $data['summary']  = get_customers_summary();
        ...
        $this->load->view('admin/customers/manage_leads', $data);
    }
    ...
    public function kanban()
    {
        ...
        echo $this->load->view('admin/customers/kan-ban', $data, true);
    }
    ...
    // print_r($this->_get_lead_data($id));die;
        echo json_encode([
            'leadView' => $this->_get_lead_data($id),
        ]);
    }
    ...
    private function _get_lead_data($id = '')
    {
        ...
        // print_r($reminder_data);die;
        return [
            'data'          => $this->load->view('admin/customers/lead', $data, true),
    ...
    public function leads_kanban_load_more()
    {
        ...
        foreach ($leads as $lead) {
            $this->load->view('admin/customers/_kan_ban_card', [
                'lead'   => $lead,
                'status' => $status,
            ]);
        }
    ...
    public function get_convert_data($id)
    {
        ...
        $this->load->view('admin/customers/convert_to_customer', $data);
    }
    ...
    public function form($id = '')
    {
        ...
        $this->load->view('admin/customers/formbuilder', $data);
    }
    ...
    public function forms($id = '')
    {
        ...
        $data['title'] = _l('web_to_lead');
        $this->load->view('admin/customers/forms', $data);
    }
    ...
    public function sources()
    {
        ...
        $this->load->view('admin/customers/manage_sources', $data);
    }
    ...
    public function statuses()
    {
        ...
        $this->load->view('admin/customers/manage_statuses', $data);
    }
    ...
    public function email_integration()
    {
        ...
        $this->load->view('admin/customers/email_integration', $data);
    }
    ...
    public function import()
    {
        ...
        $this->load->view('admin/customers/import', $data);
    }
