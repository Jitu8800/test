...
function app_init_admin_sidebar_menu_items()
{
    ...
    if (is_staff_member()) {
        if (has_permission('staff', '', 'view')) {
            $CI->app_menu->add_sidebar_menu_item('UserReport', [
                'name' => _l('Users Report'),
                'href' => admin_url('userreport'),
                'icon' => 'fa fa-file',
                'position' => 2,
                'badge' => [],
            ]);
    ...
    if (has_permission('staff', '', 'view')) {
        ...
        $CI->app_menu->add_setup_menu_item('master-data', [
            'collapse' => true,
            'name' => _l('master_data'),
            'position' => 5,
            'badge' => [],
        ...
        $CI->app_menu->add_setup_children_item('master-data', [
            'slug' => 'master-user',
            'name' => _l('md_user'),
            'href' => admin_url('staff'),
            'position' => 5,
    ...
    if (is_admin()) {
        ...
        $CI->app_menu->add_setup_children_item('leads', [
            'slug' => 'campaign-assignments',
            'name' => _l('campaign_assignments'),
            'href' => admin_url('campaign'),
            'position' => 19,
            'badge' => [],
        ]);
        ...
        $CI->app_menu->add_setup_children_item('leads', [
            ...
            'name' => _l('Leads Management'),
            'href' => admin_url('leads/management'),
            'position' => 21,
            'badge' => [],
        ]);
