...
if (isset($lead) && !empty($lead->branch_id)) {
    $selected = $lead->branch_id;
} elseif (!empty($branch_id)) {
    $selected = $branch_id;
} elseif (isset($member) && !empty($member->branch_id)) {
...
if (isset($member) && !empty($member->language)) {
    $selected = $member->language;
} elseif (isset($lead) && !empty($lead->language)) {
    $selected = $lead->language;
} elseif (!empty($language)) {
    $selected = $language;
}

$valid_langs = array_column($languages, 'id');
if (!in_array($selected, $valid_langs)) {
    $selected = 'en';
}
...
?>
                                ...
                                <?php $value = (isset($member) ? $member->dialer_phone : ''); ?>
                                <?php echo render_input('dialer_phone', 'staff_add_edit_dialer_phone', $value); ?>
                                <?php $value = (isset($member) ? $member->dialer_agent_id : ''); ?>
                                <?php echo render_input('dialer_agent_id', 'staff_add_edit_dialer_agent_id', $value); ?>
                                <?php $value = (isset($member) ? $member->dialer_login_username : ''); ?>
                                <?php echo render_input('dialer_login_username', 'staff_add_edit_dialer_login_username', $value); ?>
                                <?php $value = (isset($member) ? $member->dialer_login_password : ''); ?>
                                <?php echo render_input('dialer_login_password', 'staff_add_edit_dialer_login_password', $value); ?>
                                <div class="form-group">
