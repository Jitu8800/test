        ...
        echo $member->skype;
            ...
            <div class="col-md-5">
                ...
                <div class="panel_s">
                 ...
                 <h4 class="tw-mt-0 tw-font-semibold tw-text-lg tw-text-neutral-700">
                    <?php echo _l('Dailer credential'); ?>
                </h4>
                <p>Dialer Phone: <label><?php echo $member->dialer_phone ?? ''; ?></label> </p> 
                <p>Dialer User Name: <label><?php echo $member->dialer_login_username ?? ''; ?></label> </p>
                <p>Dialer Password: <label><?php echo $member->dialer_login_password ?? ''; ?></label> </p>
                <?php echo form_close(); ?>
