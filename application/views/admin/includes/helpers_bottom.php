...
<div class="modal fade customer-modal" id="customer-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
  <div class="modal-dialog <?php echo get_option('customer_modal_class'); ?>">
    <div class="modal-content data">
