        ...
        <div class="quick-stats-leads col-xs-12 col-md-6 col-sm-6 <?php echo $initial_column; ?> tw-mb-2 sm:tw-mb-0">
            <div class="top_stats_wrapper">
                <?php
                  ...
                  $total_leads_pipeline         = total_rows(db_prefix() . 'leads', $where);
                  $percent_total_leads_pipeline = ($total_leads > 0 ? number_format(($total_leads_pipeline * 100) / $total_leads, 2) : 0);
                  ?>
                <div class="tw-text-neutral-800 mtop5 tw-flex tw-items-center tw-justify-between">
                    <div class="tw-font-medium tw-inline-flex text-neutral-600 tw-items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        ...
                        <?php echo _l('Closed Leads'); ?>
                    </div>
                    <span class="tw-font-semibold tw-text-neutral-600 tw-shrink-0">
                        <?php echo $total_leads_pipeline; ?> /
                        <?php echo $total_leads; ?>
                    </span>
                </div>
                ...
                <div class="progress tw-mb-0 tw-mt-4 progress-bar-mini">
                    <div class="progress-bar progress-bar-warning no-percent-text not-dynamic" role="progressbar"
                        aria-valuenow="<?php echo $percent_total_leads_pipeline; ?>" aria-valuemin="0"
                        aria-valuemax="100" style="width: 0%"
                        data-percent="<?php echo $percent_total_leads_pipeline; ?>">
                    </div>
                </div>
            </div>
        </div>
        <div class="quick-stats-leads col-xs-12 col-md-6 col-sm-6 <?php echo $initial_column; ?> tw-mb-2 sm:tw-mb-0">
            <div class="top_stats_wrapper">
                <?php
                  ...
                  $total_leads_rejected         = total_rows(db_prefix() . 'leads', $where);
                  $percent_total_leads_rejected = ($total_leads > 0 ? number_format(($total_leads_rejected * 100) / $total_leads, 2) : 0);
                  ?>
                <div class="tw-text-neutral-800 mtop5 tw-flex tw-items-center tw-justify-between">
                    <div class="tw-font-medium tw-inline-flex text-neutral-600 tw-items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        ...
                        <?php echo _l('Reject Leads'); ?>
                    </div>
                    <span class="tw-font-semibold tw-text-neutral-600 tw-shrink-0">
                        <?php echo $total_leads_rejected; ?> /
                        <?php echo $total_leads; ?>
                    </span>
                </div>
                ...
                <div class="progress tw-mb-0 tw-mt-4 progress-bar-mini">
                    <div class="progress-bar progress-bar-danger no-percent-text not-dynamic" role="progressbar"
                        aria-valuenow="<?php echo $percent_total_leads_rejected; ?>" aria-valuemin="0"
                        aria-valuemax="100" style="width: 0%"
                        data-percent="<?php echo $percent_total_leads_rejected; ?>">
                    </div>
                </div>
            </div>
        </div>
