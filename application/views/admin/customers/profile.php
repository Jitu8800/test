...
<div class="<?php if ($openEdit == true) {
    ...
    if ($lead->lost == 0 && (total_rows(db_prefix() . 'clients', ['leadid' => $lead->id]) == 0)) { ?>
        ...
        if ($lead->junk == 0 && (total_rows(db_prefix() . 'clients', ['leadid' => $lead->id]) == 0)) { ?>
            ...
            <li>
                <a href="<?php echo admin_url('customers/delete/' . $lead->id); ?>" class="text-danger delete-text _delete"
    ...
    <div class="alert alert-warning hide mtop20" role="alert" id="lead_proposal_warning">
        ...
        <br />
        <a href="#" onclick="init_customer_modal_data(<?php echo $lead->id; ?>); return false;">
            <?php echo _l('update_proposal_email_no'); ?>
        </a>
    </div>
    <?php } ?>
    <?php echo form_open((isset($lead) ? admin_url('customers/lead/' . $lead->id) : admin_url('customers/lead')), ['id' => 'customer_form']); ?>
    <div class="row">
        <div class="lead-view<?php if (!isset($lead)) {
          echo ' hide';
      } ?>" id="customerViewWrapper">
            <div class="col-md-4 col-xs-12 lead-information-col">
                ...
                <dl>
                    ...
                    <dt class="lead-field-heading tw-font-medium tw-text-neutral-500"><?php echo _l('Job'); ?>
                    </dt>
                     <dd class="tw-text-neutral-900 tw-mt-1">
                        <?php echo(isset($lead) && $lead->job != '' ? $lead->job : '-') ?></dd>
                    <dt class="lead-field-heading tw-font-medium tw-text-neutral-500"><?php echo _l('Source Campaign'); ?>
                    </dt>
                    <dd class="tw-text-neutral-900 tw-mt-1">
                        <?php echo(isset($lead) && $lead->source_campaign != '' ? $lead->source_campaign : '-') ?></dd>
            ...
            <div class="col-md-4 col-xs-12 lead-information-col">
                ...
                <dl>
                    ...
                    <dt class="lead-field-heading tw-font-medium tw-text-neutral-500"><?php echo _l('tags'); ?>
                    </dt>
        ...
        <div class="clearfix"></div>
        <div class="customer-edit<?php if (isset($lead)) {
                echo ' hide';
            } ?>">
          ...
          ?>
            ...
            <div class="col-md-6">
                ...
                <?php echo render_input('phonenumber', 'Phone Number', $value, 'number'); ?>

                <?php $value = (isset($lead) ? $lead->email : ''); ?>
                <?php echo render_input('email', 'Email', $value); ?>

                 <?php $value = (isset($lead) ? $lead->source_campaign : ''); ?>
                <?php echo render_input('source_campaign', 'Source Campaign', $value); ?>
            </div>
            ...
            <div class="col-md-6 mt-4">
                ...
                <?php $value = (isset($lead) ? $lead->job : ''); ?>
                <?php echo render_input('job', 'Job', $value); ?>

                <?php $value = (isset($lead) ? $lead->payin_amount : ''); ?>
                <?php echo render_input('payin_amount', 'Payin Amount', $value); ?>

                <?php $value = (isset($lead) ? $lead->payout_amount : ''); ?>
                <?php echo render_input('payout_amount', 'Payout Amount', $value); ?>
            ...
            <div class="col-md-12">
                ...
                <?php echo render_textarea('description', 'Notes/Description', $value); ?>
                <div class="row">
                    <div class="col-md-12">
                        <?php if (!isset($lead)) { ?>
    ...
    <?php } ?>
    <?php if ($lead_locked == false) { ?>
    <div class="customer-edit<?php echo isset($lead) ? ' hide' : ''; ?>">
        <hr class="-tw-mx-4 tw-border-neutral-200" />
        <button type="submit" class="btn btn-primary pull-right customer-save-btn" id="customer-form-submit">
            <?php echo _l('submit'); ?>
        </button>
