                ...
                <div class="_buttons tw-mb-2 sm:tw-mb-4">
                    ...
                    <div class="row">
                        <div class="col-sm-5 ">
                            ...
                            <a href="<?php echo admin_url('customers/switch_kanban/' . $switch_kanban); ?>"
                    ...
                    <div class="<?php echo $isKanBan ? '' : 'panel-body' ; ?>">
                        ...
                        if ($isKanBan) { ?>
                            ...
                            <div class="row" id="customer-table">
                                ...
                                <div class="col-md-12">
                                    <a href="#" data-toggle="modal" data-table=".table-customers"
                                        data-target="#customers_bulk_actions"
                                        class="hide bulk-actions-btn table-btn"><?php echo _l('bulk_actions'); ?></a>
                                    <div class="modal fade bulk_actions" id="customers_bulk_actions" tabindex="-1"
                                        role="dialog">
                              ...
                              $_table_data[] = [
                               ...
                               'th_attrs' => ['class' => 'toggleable', 'id' => 'th-source'],
                                ...
                                $_table_data[] = [
                                 'name'     => _l('Job'),
                                 'th_attrs' => ['class' => 'toggleable', 'id' => 'th-job'],
                                ];
                                $_table_data[] = [
                                 'name'     => _l('Description'),
...
<script id="hidden-columns-table-customers" type="text/json">
<?php echo get_staff_meta(get_staff_user_id(), 'hidden-columns-table-customers'); ?>
</script>
<?php include_once(APPPATH . 'views/admin/customers/status.php'); ?>
<?php init_tail(); ?>
<script>
