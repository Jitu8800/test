...
<div class="modal-header">
    ...
    echo '#' . $lead->id . ' - ' . $name;
        ...
        echo _l('Add new customer', _l('lead_lowercase'));
    }
    ...
    echo ' lead-new';
            ...
            <div class="tab-content">
                ...
                <div role="tabpanel" class="tab-pane active" id="tab_lead_profile">
                    <?php $this->load->view('admin/customers/profile'); ?>
                </div>
                <?php if (isset($lead)) { ?>
                <?php if (count($mail_activity) > 0 || isset($show_email_activity) && $show_email_activity) { ?>
                ...
                <div role="tabpanel" class="tab-pane" id="attachments">
                    <?php echo form_open('admin/customers/add_lead_attachment', ['class' => 'dropzone mtop15 mbot15', 'id' => 'lead-attachment-upload']); ?>
                    <?php echo form_close(); ?>
                    ...
                    <div class="mtop20" id="lead_attachments">
                        <?php $this->load->view('admin/customers/leads_attachments_template', ['attachments' => $lead->attachments]); ?>
                    </div>
                    <?php } ?>
                </div>
