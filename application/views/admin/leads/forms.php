...
<div id="wrapper">
    ...
    <div class="dashboard">
        <div class="header">
            ...
            <a href="<?php echo admin_url('leads/sources/'); ?>" class="btn-create">
                Create +
            </a>
        </div>
...
if (count($campaigns) > 0) {
    foreach ($campaigns as $campaign) { ?>
                    <tr data-source="<?php echo htmlspecialchars($campaign['source']); ?>"
                        data-campaigns="<?php echo htmlspecialchars($campaign['campaigns']); ?>">
                        <td><?php echo $i++; ?></td>
                        ...
                        <td>
                            ...
                            <select name="campaign" class="branchSelectMultiple">
                                <option value="ALL">ALL</option>
                                <?php foreach ($campaignList as $c) { ?>
                                <option value="<?php echo htmlspecialchars(trim($c)); ?>">
                        ...
                        <td>
                            <form class="assign_leads_form" action="<?php echo admin_url('leads/assign_leads'); ?>"
                                ...
                                <button type="submit" class="btn btn-primary btn-assign" onclick="return confirm('Please recheck selected fields. This action is not reversible!');">Assign</button>
...
$(document).ready(function() {
    ...
    $(document).on('submit', '.assign_leads_form', function(e) {
        ...
        formData.append('source_id', $tr.data('source'));
        formData.append('campaign', $tr.find('select[name="campaign"]').val());
