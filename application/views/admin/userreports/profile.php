            ...
            <div class="col-md-6">
               ...
               ?>
                ...
                echo render_select(
                    ...
                    <?php echo render_input('total_payment', 'Total Payment', $value); ?>
                    <?php $value = (isset($lead) ? $lead->payment_due : ''); ?>
                    <?php echo render_input('payment_due', 'Payment Due', $value); ?>
                    <?php $value = (isset($lead) ? $lead->payment_discount : ''); ?>
                    <?php echo render_input('payment_discount', 'Payment Discount', $value); ?>
