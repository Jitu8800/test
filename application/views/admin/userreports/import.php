...
<div id="wrapper">
    <div class="content">
        ...
        <label for="exampleSelectMultiple" class="form-label">Responsible (Assignee)</label>
        <select id="exampleSelectMultiple" name="responsible[]" class="form-control" multiple="multiple">
